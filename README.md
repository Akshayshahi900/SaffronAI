...
|-------|------|------------------|
| **You** | Honeypot AI Architect | Build the human-like agent |
| **Teammate A** | Intelligence Extraction | Extract scam data from chats |
| **Teammate B** | API & Sessions | FastAPI, routing, session memory, GUVI callback |
| **Teammate C** | Prompt Engineer & Tester | Attack testing, prompt tuning |
